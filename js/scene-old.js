{
	...
	"materials": {
		...
		"sky_FaceMaterial": {
			...
			"parameters": { "materials": [ "skybox_front", "skybox_back", "skybox_top", "skybox_bottom", "skybox_left", "skybox_right" ] }
		},

			"skybox_front": {
				"type": "MeshBasicMaterial",
				"parameters": { "map": "skyMaterial_front", "side": "back" }
			},

			"skybox_back": {
				"type": "MeshBasicMaterial",
				"parameters": { "map": "skyMaterial_back", "side": "back" }
			},

			"skybox_top": {
				"type": "MeshBasicMaterial",
				"parameters": { "map": "skyMaterial_top", "side": "back" }
			},

			"skybox_bottom": {
				"type": "MeshBasicMaterial",
				"parameters": { "map": "skyMaterial_bottom", "side": "back" }
			},

			"skybox_left": {
				"type": "MeshBasicMaterial",
				"parameters": { "map": "skyMaterial_left", "side": "back" }
			},

			"skybox_right": {
				"type": "MeshBasicMaterial",
				"parameters": { "map": "skyMaterial_right", "side": "back" }
			},
	...
	"textures": {
		...
		"texture_minecraft": {
			...
			"skyMaterial_back": {
				"url": "textures/cube/SwedishRoyalCastle/nx.jpg"
			},

			"skyMaterial_top": {
				"url": "textures/cube/SwedishRoyalCastle/py.jpg"
			},

			"skyMaterial_bottom": {
				"url": "textures/cube/SwedishRoyalCastle/ny.jpg"
			},
			...
			"skyMaterial_right": {
				"url": "textures/cube/SwedishRoyalCastle/nz.jpg"
			}
	},
